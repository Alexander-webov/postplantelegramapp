...
const moneyStats = [
  ...
  {
    value: "5+",
    label: "каналов уже требуют не Telegram, а нормальный кабинет",
  },
  {
    value: "299 ₽",
    label: "дешевле одной ручной ошибки в рекламном размещении",
  },
];
...
const features = [
  {
    ...
    description:
      "Очередь публикаций, удобное время отправки и единый обзор: что выйдет сегодня, завтра и в этом месяце.",
  },
  {
    icon: Layers3,
    title: "Кросспостинг без копипаста",
    description:
      "Один пост можно подготовить для нескольких Telegram-каналов и не прыгать между админками.",
  },
  {
    icon: WalletCards,
    title: "Рекламодатели и деньги",
    description:
      "Храни клиентов, стоимость размещений и историю публикаций рядом с контентом, а не в отдельной таблице.",
  },
  {
    icon: Trash2,
    title: "Автоудаление рекламных постов",
    description:
      "Задай срок жизни размещения и не вспоминай ночью, какой пост нужно снять с канала.",
  },
  {
    icon: BarChart3,
    title: "Просмотры и отчёты",
    description:
      "Смотри результат публикаций и быстрее готовь отчёт для клиента после размещения.",
  },
  {
    icon: Bot,
    title: "Через официального Telegram-бота",
    description:
      "Без userbot-ов и серых схем. Ты сам добавляешь бота админом в канал и контролируешь доступ.",
  },
];
...
const workflow = [
  {
    title: "Подключи бота",
    description: "Создай бота в BotFather и добавь его админом канала.",
  },
  {
    title: "Добавь каналы",
    description: "Собери все Telegram-проекты в одном кабинете.",
  },
  {
    title: "Запланируй посты",
    description:
      "Готовь контент заранее, прикрепляй медиа и ставь время публикации.",
  },
  {
    title: "Веди рекламу",
    description: "Привязывай размещения к рекламодателям и считай выручку.",
  },
];
    ...
    <header className="sticky top-0 z-40 border-b border-border bg-background/82 backdrop-blur-xl">
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 md:px-6">
        ...
        <nav className="hidden items-center gap-7 text-sm text-muted-foreground md:flex">
          <a href="#features" className="transition-base hover:text-foreground">
            Возможности
          </a>
          <a href="#workflow" className="transition-base hover:text-foreground">
            Как работает
          </a>
          <a href="#pricing" className="transition-base hover:text-foreground">
            Тарифы
          </a>
          <a href="#faq" className="transition-base hover:text-foreground">
            Вопросы
          </a>
        </nav>
...
function Hero() {
  return (
    <section className="relative border-b border-border pb-16 pt-14 md:pb-24 md:pt-20">
      <div
        className="pointer-events-none absolute left-1/2 top-0 h-[520px] w-[920px] -translate-x-1/2 rounded-full bg-primary/10 blur-3xl"
        aria-hidden
      />
      <div
        className="pointer-events-none absolute right-[-180px] top-24 h-[420px] w-[420px] rounded-full bg-success/10 blur-3xl"
        aria-hidden
      />

      <div className="relative mx-auto grid max-w-7xl items-center gap-12 px-4 md:px-6">
        <div>
          ...
          <p className="mt-6 max-w-2xl text-lg leading-8 text-muted-foreground md:text-xl">
            Постплан помогает планировать посты, вести рекламодателей, считать
            выручку и не терять публикации в заметках, чатах и таблицах.
          </p>
          ...
          <div className="mt-5 flex flex-wrap items-center gap-x-5 gap-y-2 text-sm text-muted-foreground">
            <span className="inline-flex items-center gap-1.5">
              <Check className="h-4 w-4 text-success" /> без карты
            </span>
            <span className="inline-flex items-center gap-1.5">
              <Check className="h-4 w-4 text-success" /> Free навсегда
            </span>
            <span className="inline-flex items-center gap-1.5">
              <Check className="h-4 w-4 text-success" /> тарифы от 299 ₽/мес
            </span>
          </div>
          ...
          <div className="mt-9 grid gap-3 sm:grid-cols-3">
            {moneyStats.map((stat) => (
              <div
                key={stat.value}
                className="rounded-lg border border-border bg-card/80 p-4 shadow-xs backdrop-blur"
              >
        ...
        <div className="relative">
          <div
            className="absolute -inset-6 rounded-[2rem] bg-gradient-to-br from-primary/15 via-background to-success/10 blur-2xl"
            aria-hidden
          />
      ...
      <div className="mx-auto grid max-w-7xl gap-10 px-4 md:px-6 lg:grid-cols-[0.9fr_1.1fr]">
        <div>
          ...
          <h2 className="text-3xl font-semibold tracking-tight md:text-4xl">
            Пока канал маленький — хаос терпим. Когда появляется реклама — хаос
            начинает стоить денег.
          </h2>
          <p className="mt-4 text-muted-foreground">
            Постплан нужен не ради красивого календаря. Он нужен, чтобы владелец
            канала не терял посты, клиентов и деньги.
          </p>
        </div>
      ...
      <div className="mx-auto max-w-7xl px-4 md:px-6">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-4 text-muted-foreground md:text-lg">
            Сначала ты планируешь посты. Потом добавляешь рекламодателей. Потом
            видишь, сколько реально приносит твоя сетка каналов.
          </p>
        </div>
        ...
        <div className="mt-12 grid gap-5 md:grid-cols-2 lg:grid-cols-3">
          {features.map((f) => {
            ...
            return (
              <div
                key={f.title}
                className="group rounded-xl border border-border bg-card p-6 shadow-xs transition-base hover:-translate-y-1 hover:border-primary/30 hover:shadow-lg"
              >
...
function Workflow() {
  return (
    <section
      id="workflow"
      className="border-b border-border bg-card py-20 md:py-28"
    >
      <div className="mx-auto max-w-7xl px-4 md:px-6">
        <div className="grid gap-10 lg:grid-cols-[0.8fr_1.2fr] lg:items-start">
          <div>
            ...
            <p className="mt-4 text-muted-foreground">
              Пользователь должен быстро понять ценность: подключил канал,
              запланировал пост, увидел порядок в работе.
            </p>
    ...
    <section className="border-b border-border bg-surface-sunken/40 py-20 md:py-28">
      <div className="mx-auto max-w-5xl px-4 md:px-6">
        <div className="text-center">
          ...
          <h2 className="text-3xl font-semibold tracking-tight md:text-4xl">
            Telegram умеет отложить пост. Он не умеет вести бизнес вокруг
            канала.
          </h2>
          <p className="mt-4 text-muted-foreground">
            Если ты просто публикуешь иногда — хватит Telegram. Если ты
            управляешь каналом как активом — нужен кабинет.
          </p>
        </div>
        ...
        <div className="mt-10 overflow-hidden rounded-xl border border-border bg-card shadow-sm">
          ...
          {comparison.map((row, i) => (
            <div
              key={row.capability}
              className={`grid grid-cols-[1fr_110px_110px] items-center px-4 py-3 text-sm md:grid-cols-[1fr_140px_140px] ${i > 0 ? "border-t border-border/60" : ""}`}
            >
    ...
    <section id="pricing" className="border-b border-border py-20 md:py-28">
      <div className="mx-auto max-w-7xl px-4 md:px-6">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-4 text-muted-foreground md:text-lg">
            Начни бесплатно. Когда канал начнёт работать регулярно — выбери
            тариф под количество каналов.
          </p>
        </div>
        ...
        <div className="mx-auto mt-12 grid max-w-6xl gap-6 lg:grid-cols-3">
          {tierKeys.map((tier) => {
            ...
            return (
              <div
                key={tier}
                className={`relative rounded-2xl border bg-card p-6 shadow-sm transition-base hover:-translate-y-1 hover:shadow-lg ${isPopular ? "border-primary ring-1 ring-primary/25" : "border-border"} ${isPro ? "bg-foreground text-background" : ""}`}
              >
                {isPopular && (
                ...
                <div className="flex items-center justify-between gap-3">
                  <div className="flex items-center gap-2">
                    <div
                      className={`flex h-9 w-9 items-center justify-center rounded-lg ${isPro ? "bg-background text-foreground" : tier === "start" ? "bg-primary-soft text-primary-soft-foreground" : "bg-muted text-muted-foreground"}`}
                    >
                ...
                <div className="mt-5 flex items-end gap-1">
                  ...
                  <span
                    className={`pb-2 text-sm ${isPro ? "text-background/65" : "text-muted-foreground"}`}
                  >
                    ₽ / мес
                  </span>
                </div>
                ...
                <p
                  className={`mt-3 text-sm leading-6 ${isPro ? "text-background/70" : "text-muted-foreground"}`}
                >
                  {tier === "free"
                ...
                <ul className="mt-6 space-y-2.5 text-sm">
                  {features.map((f, i) => (
                    <li
                      key={i}
                      className={`flex items-start gap-2 ${!f.included ? (isPro ? "text-background/35" : "text-muted-foreground/55") : ""}`}
                    >
                      {f.included ? (
                        <Check
                          className={`mt-0.5 h-4 w-4 shrink-0 ${isPro ? "text-success" : "text-success"}`}
                        />
                      ) : (
                ...
                <Button
                  asChild
                  className={`mt-7 w-full ${isPro ? "bg-background text-foreground hover:bg-background/90" : ""}`}
        ...
        <div className="mx-auto mt-8 flex max-w-3xl flex-wrap items-center justify-center gap-x-5 gap-y-2 text-center text-xs text-muted-foreground">
          <span className="inline-flex items-center gap-1.5">
            <ShieldCheck className="h-3.5 w-3.5" /> оплата через YooKassa
          </span>
          <span className="inline-flex items-center gap-1.5">
            <BadgeCheck className="h-3.5 w-3.5" /> цены в рублях
          </span>
          <span className="inline-flex items-center gap-1.5">
            <Clock3 className="h-3.5 w-3.5" /> перейти на тариф можно в любой
            момент
          </span>
        </div>
      </div>
    ...
    <section id="faq" className="border-b border-border bg-card py-20 md:py-28">
      <div className="mx-auto max-w-3xl px-4 md:px-6">
        <div className="text-center">
          ...
          <h2 className="text-3xl font-semibold tracking-tight md:text-4xl">
            Перед оплатой обычно спрашивают это
          </h2>
        </div>
        ...
        <div className="mt-10 space-y-3">
          {faq.map((item) => (
            <details
              key={item.q}
              className="group rounded-xl border border-border bg-background p-5 transition-base open:shadow-sm"
            >
...
function FinalCTA() {
  return (
    <section className="relative overflow-hidden py-20 md:py-28">
      <div
        className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_at_center,hsl(var(--primary)/0.16),transparent_60%)]"
        aria-hidden
      />
      <div className="relative mx-auto max-w-4xl px-4 text-center md:px-6">
        ...
        <h2 className="text-3xl font-semibold tracking-tight md:text-5xl">
          Лучше один раз увидеть порядок в кабинете, чем ещё месяц вести канал в
          заметках.
        </h2>
        <p className="mx-auto mt-5 max-w-2xl text-muted-foreground md:text-lg">
          Зарегистрируйся, подключи Telegram-бота и запланируй первый пост. Без
          карты и без риска.
        </p>

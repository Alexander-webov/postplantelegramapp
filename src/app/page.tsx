...
const whoFor = [
  "Админ Telegram-канала которому требуется удобный автопостинг",
  "Владельцам которым требуется подробная статистика за каждый пост",
  "Медиа-сетка из 5 или даже 50 каналов с удобным интерфейсам ",
];
...
const steps = [
  {
    n: 1,
    icon: Users,
    title: "Регистрация и добавления канала",
    body: "После мега-быстрой регистрации в Постплан. Вам нужно выполнить два шага, добавить бота и добавить ваш канал в систему. Это очень легко и быстро, у на есть инструкция.",
  },
  {
    n: 2,
    icon: FileText,
    title: "Моя первая публикация",
    body: "Пойти на страницу создать пост и выбрать оформление поста и дату если требуется. Это очень удобно!",
  },
  {
    n: 3,
    icon: Link2,
    title: "Результат",
    body: "После того как вы сделали свою работу, программа начнет публиковать посты когда вы указали и сколько вы указали. Вам остается только довериться нам и смотреть как ваши посты набирают просмотры.",
  },
];
    ...
    <section className="relative border-b border-border pb-20 pt-16 md:pb-28 md:pt-24">
      <div className="mx-auto max-w-4xl px-4 text-center sm:px-6">
        <Badge variant="outline" className="mb-6 gap-1.5 border-primary/30 bg-primary-soft text-primary-soft-foreground">
          ...
          Самый удобный ПОСТИНГ в телеграм
        </Badge>

        <h1 className="text-balance text-4xl font-semibold tracking-tight md:text-5xl lg:text-6xl">
           Отлаженный постинг в телгерам <span className="text-primary">с самым удобным интерфейсом и богатым функционалом</span>
        </h1>

        <p className="mx-auto mt-6 max-w-2xl text-balance text-lg text-muted-foreground md:text-xl">
          Постплан — единственный многофункциональный Telegram комбайн, который собирает за тебя историю размещений по каждому посту, делает авто-публикацию, имеет функционал взаимопиара и многое
          другое!
        </p>

...
export const metadata = {
  ...
  description:
    'Веди базу рекламодателей, планируй размещения и автоматически собирай отчёт со скриншотом, охватами и ссылкой на пост. От 299 ₽/мес.',
};

// ----- Content blocks --------------------------------------------------------

const whoFor = [
  'Админ Telegram-канала продаёт рекламу клиентам',
  'СММ-агентство ведёт каналы под нескольких рекламодателей',
  'Медиа-сетка из 5+ каналов с общим прайсом и отчётностью',
];
...
const steps = [
  {
    ...
    body:
      'Имя клиента, контакт, согласованная цена. Все размещения автоматически привязываются к карточке — больше никаких "у Васи 5 постов с октября, не помню точно".',
  },
  {
    n: 2,
    icon: FileText,
    ...
    body:
      'Каждое размещение → отдельная страница с твоим оформлением: пост, охваты через 1ч/6ч/24ч/48ч, дата публикации, ссылка на канал. Просто скидываешь клиенту ссылку.',
  },
  {
    n: 3,
    icon: Link2,
    ...
    body:
      'В CRM сразу видно: сколько размещений на этой неделе, у кого, на какую сумму, какие свободные слоты остались. Excel и WhatsApp можно закрыть.',
  },
];
  ...
  const jsonLd = {
    ...
    '@graph': [
      ...
      },
      {
        ...
        operatingSystem: 'Web',
        description:
          'Планировщик постов в Telegram-канала с CRM рекламодателей и автоматическим отчётом клиенту.',
        offers: {
          '@type': 'AggregateOffer',
          priceCurrency: 'RUB',
          lowPrice: '0',
    ...
    <header className="sticky top-0 z-40 border-b border-border bg-background/82 backdrop-blur-xl">
      <div className="mx-auto flex h-16 max-w-6xl items-center justify-between px-4 sm:px-6">
        ...
        <nav className="hidden items-center gap-7 text-sm text-muted-foreground md:flex">
          ...
          <a href="#compare" className="hover:text-foreground">Сравнение</a>
    ...
    <section className="relative border-b border-border pb-20 pt-16 md:pb-28 md:pt-24">
      <div className="mx-auto max-w-4xl px-4 text-center sm:px-6">
        ...
        <h1 className="text-balance text-4xl font-semibold tracking-tight md:text-5xl lg:text-6xl">
          Веди CRM рекламодателей{' '}
          <span className="text-primary">и отдавай клиенту готовый отчёт по ссылке</span>
        </h1>

        <p className="mx-auto mt-6 max-w-2xl text-balance text-lg text-muted-foreground md:text-xl">
          Постплан — единственный планировщик Telegram, который собирает за тебя
          историю размещений по каждому рекламодателю и автоматически делает
          публичную страницу-отчёт с охватами.
        </p>
        ...
        <p className="mt-5 text-sm text-muted-foreground">
          Без триала. Free навсегда — 1 канал и 10 постов в месяц.
        </p>
      </div>
    </section>
  );
      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="mb-14 text-center">
          <h2 className="text-balance text-3xl font-semibold tracking-tight md:text-4xl">
            Как Постплан экономит твоё время
          </h2>
          <p className="mx-auto mt-3 max-w-2xl text-muted-foreground">
            Три простые вещи, которые в SmmPlanner или Postmypost нужно вести вручную в Excel или забыть.
          </p>
        </div>
      ...
      <div className="mx-auto grid max-w-6xl gap-12 px-4 sm:px-6 lg:grid-cols-2 lg:items-center">
        <div>
          ...
          <h2 className="text-balance text-3xl font-semibold tracking-tight md:text-4xl">
            Одна ссылка вместо
            <br />
            «пришли пожалуйста скрин просмотров»
          </h2>
          <div className="mt-6 space-y-4 text-muted-foreground">
            <p>
              Когда пост опубликован, Постплан собирает охваты сам — на 1, 6, 24 и 48
              часов. Эти цифры автоматически попадают на публичную страницу размещения,
              которая лежит по короткому URL вида <code className="rounded bg-card px-1.5 py-0.5 text-xs text-foreground">postplan-tg.ru/r/abc123</code>.
            </p>
            <p>
              Кидаешь ссылку клиенту — он открывает и видит всё: сам пост, время выхода,
              охваты на разных интервалах, ссылку на канал. Без регистрации, без
              скриншотов, без переписки.
            </p>
            <ul className="space-y-2 pt-2">
              {[
                'Срабатывает автоматически после публикации',
                'Брендировано под твой канал',
                'Не требует от клиента никаких аккаунтов',
                'Можно отправить как ссылку или как превью в TG',
              ].map((line) => (
            ...
            <div className="space-y-5 px-6 py-7">
              <div>
                ...
                <p className="mt-1.5 text-lg font-semibold tracking-tight">
                  Подборка курсов по дизайну
                </p>
                <p className="mt-0.5 text-sm text-muted-foreground">
                  Канал «Дизайн каждый день» · опубликовано 12 марта в 14:00
                </p>
              </div>

              <div className="rounded-lg border border-border bg-surface-sunken/30 p-4 text-sm leading-relaxed">
                Подобрали для вас 7 курсов по UX/UI — от старта до сеньорных
                интенсивов. Бесплатные и платные…
              </div>
    ...
    <section id="compare" className="border-b border-border py-20 md:py-28">
      <div className="mx-auto max-w-5xl px-4 sm:px-6">
        <div className="mb-12 text-center">
          <h2 className="text-balance text-3xl font-semibold tracking-tight md:text-4xl">
            Чем отличается от того, чем ты пользуешься сейчас
          </h2>
          <p className="mx-auto mt-3 max-w-2xl text-muted-foreground">
            ...
            <tbody className="divide-y divide-border">
              {comparison.map((row, i) => (
                <tr key={i}>
                  ...
                  <td className="px-3 py-3.5 text-center"><Mark v={row.postplan} accent /></td>
                  <td className="px-3 py-3.5 text-center"><Mark v={row.smm} /></td>
                  <td className="px-3 py-3.5 text-center"><Mark v={row.excel} /></td>
                </tr>
              ))}
            </tbody>
          </table>
...
function Mark({ v, accent = false }: { v: boolean | string; accent?: boolean }) {
  if (v === true) {
    return (
      <Check
        className={`mx-auto h-5 w-5 ${accent ? 'text-primary' : 'text-success'}`}
        aria-label="да"
      />
    );
  }
  ...
  return (
    <section id="pricing" className="border-b border-border bg-surface-sunken/30 py-20 md:py-28">
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="mb-12 text-center">
          <h2 className="text-balance text-3xl font-semibold tracking-tight md:text-4xl">
            Тарифы — без триалов, без сюрпризов
          </h2>
          <p className="mx-auto mt-3 max-w-2xl text-muted-foreground">
            CRM рекламодателей и отчёты доступны на всех платных тарифах. Free —
            чтобы попробовать.
          </p>
        </div>
            ...
            return (
              <div
                ...
                className={`relative flex flex-col rounded-xl border bg-card p-6 ${
                  isHighlight ? 'border-primary shadow-lg md:scale-[1.02]' : 'border-border'
                }`}
              >
                {isHighlight && (
                  <Badge className="absolute -top-2.5 left-6">Подходит большинству</Badge>
                )}
                <p className="text-sm font-medium text-muted-foreground">{tier.name}</p>
                <div className="mt-2 flex items-baseline gap-1">
                  <span className="text-4xl font-semibold tracking-tight">
                    {tier.priceRub === 0 ? '0' : tier.priceRub}
                  </span>
                ...
                <ul className="mt-5 space-y-2.5 text-sm">
                  ...
                  <FeatureLine enabled={tier.limits.maxCrosspostChannels > 1}>
                    Кросспост до {formatLimit(tier.limits.maxCrosspostChannels)} каналов
                  </FeatureLine>
        ...
        <p className="mt-8 text-center text-sm text-muted-foreground">
          Оплата через ЮKassa. Можно отменить в любой момент — деньги за неиспользованные дни не возвращаем, но и автосписаний нет.
        </p>
      </div>
    </section>
  );
  ...
  return (
    <section className="relative overflow-hidden py-24 md:py-32">
      ...
      <div className="mx-auto max-w-3xl px-4 text-center sm:px-6">
        ...
        <h2 className="text-balance text-3xl font-semibold tracking-tight md:text-4xl">
          Закрой Excel и WhatsApp с рекламодателями
        </h2>
        <p className="mx-auto mt-4 max-w-xl text-muted-foreground">
          Бесплатный аккаунт. Один канал. 10 постов в месяц. Этого достаточно,
          чтобы за вечер увидеть, как работает CRM и автоматический отчёт.
        </p>
      ...
      <div className="mx-auto flex max-w-6xl flex-col items-start justify-between gap-6 px-4 py-10 sm:px-6 md:flex-row md:items-center">
        <div>
          ...
          <p className="mt-2 max-w-sm text-sm text-muted-foreground">
            Планировщик с CRM рекламодателей и автоматическими отчётами для Telegram-каналов.
          </p>
        </div>
        <div className="flex flex-wrap gap-x-6 gap-y-2 text-sm text-muted-foreground">
          ...
          <Link href="/legal/terms" className="hover:text-foreground">Условия</Link>
          <a href="mailto:programm.aleks@gmail.com" className="hover:text-foreground">programm.aleks@gmail.com</a>
        </div>
      </div>
    </footer>
  );

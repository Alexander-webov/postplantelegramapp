...
export const metadata: Metadata = {
  ...
  description: "Управление Telegram-каналами из одного кабинета. Расписание постов до 3 месяцев, шаблоны, кросспостинг. От 299 ₽/мес.",
  keywords: ["постплан", "планировщик постов telegram", "отложенный постинг", "управление каналами telegram", "smm telegram", "crm рекламодателей telegram"],
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="ru" suppressHydrationWarning>
      <body
        className={cn(GeistSans.variable, GeistMono.variable, "min-h-screen bg-background font-sans antialiased")}
        style={{
        ...
        <Toaster
          ...
          toastOptions={{
            classNames: {
              ...
              error: "!border-destructive/30 !bg-destructive-soft !text-destructive [&>svg]:!text-destructive",
